...
| **Conector de pylon** | **Insert custom do design-base (Opção A)** | Votado pelo grupo em 09/06; conector retangular 26×14×46 mm integrado ao modelo — adequado para demonstração acadêmica, sem peça comprada extra |
